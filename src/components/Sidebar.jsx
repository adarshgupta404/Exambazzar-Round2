...
const Sidebar = () => {
  // {Functionality is same as the laptop view except some minor changes}
  ...
  // Added click effect using use states
  ...
  // Handle the toggling of sidebar
  const handleToggle = () => {
    console.log("clicked!");
    setClicked(!clicked);
  };
        ...
        >
          ...
          {clicked ? (
            <ul className="border-t-2">
              ...
              <li
                className={` ${
                  liclicked.links ? "md:bg-green-200 text-green-600" : ""
              ...
              <li
                className={` ${
                  liclicked.summ ? "md:bg-green-200 text-green-600" : ""
                } p-4 pl-16  border-b-2`}
              ...
              <li
                className={` ${
                  liclicked.details ? "md:bg-green-200 text-green-600" : ""
                } p-4 pl-16 border-b-2`}
